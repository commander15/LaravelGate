...
void LaravelRestController::registerResponse(RestLink::Response *response, const std::function<RestLink::ApiRunCallback> &callback, const DataGate::DataQueryProgressCallback &onProgress)
{
